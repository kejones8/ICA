...
#1.1 usfs
fed_usfs_burn<-read.csv("data\\JCA\\usfs_count_burn.csv")
fed_usfs_burn$X<-NULL
colnames(fed_usfs_burn)[2]<-"usfs_burn_count"
fed_usfs_threat<-read.csv("data\\JCA\\usfs_count_threat.csv")
...
#1.2 nps
fed_nps_burn<-read.csv("data\\JCA\\nps_count_burn.csv")
fed_nps_burn$X<-NULL
colnames(fed_nps_burn)[2]<-"nps_burn_count"
fed_nps_threat<-read.csv("data\\JCA\\nps_count_threat.csv")
...
#1.3 usfws
fed_usfws_burn<-read.csv("data\\JCA\\usfws_count_burn.csv")
fed_usfws_burn$X<-NULL
colnames(fed_usfws_burn)[2]<-"usfws_burn_count"
fed_usfws_threat<-read.csv("data\\JCA\\usfws_count_threat.csv")
...
fed_tva_burn<-read.csv("data\\JCA\\tva_burn_count.csv")
fed_tva_burn$X<-NULL
colnames(fed_tva_burn)[2]<-"tva_burn_count"
fed_tva_threat<-read.csv("data\\JCA\\tva_threat_count.csv")
...
#1.5 bor
fed_bor_burn<-read.csv("data\\JCA\\bor_burn_count.csv")
fed_bor_burn$X<-NULL
colnames(fed_bor_burn)[2]<-"bor_burn_count"
fed_bor_threat<-read.csv("data\\JCA\\bor_threat_count.csv")
...
#1.6 doe
fed_doe_burn<-read.csv("data\\JCA\\doe_burn_count.csv")
fed_doe_burn$X<-NULL
colnames(fed_doe_burn)[2]<-"doe_burn_count"
fed_doe_threat<-read.csv("data\\JCA\\doe_threat_count.csv")
...
#1.7 dod
fed_dod_burn<-read.csv("data\\JCA\\dod_burn_count.csv")
fed_dod_burn$X<-NULL
colnames(fed_dod_burn)[2]<-"dod_burn_count"
fed_dod_threat<-read.csv("data\\JCA\\dod_threat_count.csv")
...
#1.8 blm
fed_blm_burn<-read.csv("data\\JCA\\burn_blm_cnt.csv")
fed_blm_burn$X<-NULL
colnames(fed_blm_burn)[2]<-"blm_burn_count"
fed_blm_threat<-read.csv("data\\JCA\\threat_blm_cnt.csv")
...
#2.1 ancsa
trib_ancsa_burn<-read.csv("data\\JCA\\ancsa_burn_count.csv")
trib_ancsa_burn$X<-NULL
colnames(trib_ancsa_burn)[2]<-"ancsa_burn_count"
trib_ancsa_threat<-read.csv("data\\JCA\\ancsa_threat_count.csv")
...
#2.2 oth tribal 
trib_othtrib_burn<-read.csv("data\\JCA\\othtrib_count_burn.csv")
trib_othtrib_burn$X<-NULL
colnames(trib_othtrib_burn)[2]<-"othtrib_burn_count"
trib_othtrib_threat<-read.csv("data\\JCA\\othtrib_count_threat.csv")
...
#2.3 bia 
trib_bia_burn<-read.csv("data\\JCA\\burn_bia_cnt.csv")
trib_bia_burn$X<-NULL
colnames(trib_bia_burn)[2]<-"bia_burn_count"
trib_bia_threat<-read.csv("data\\JCA\\threat_bia_cnt.csv")
...
###3. all states 
#3.1 state 
st_cnt_burn<-read.csv("data\\JCA\\burn_st_count.csv")
st_cnt_burn$X<-NULL
colnames(st_cnt_burn)[2]<-"st_burn_count"
st_cnt_threat<-read.csv("data\\JCA\\threat_st_count.csv")
...
#4. county 
#4.1 county 
county_cnt_burn<-read.csv("data\\JCA\\burn_cnty_count.csv")
county_cnt_burn$X<-NULL
colnames(county_cnt_burn)[2]<-"cnty_burn_count"
county_cnt_threat<-read.csv("data\\JCA\\threat_cnty_count.csv")
...
#5. census place 
#5.1 census place 
cenpl_cnt_burn<-read.csv("data\\JCA\\count_cenpl_burn.csv")
cenpl_cnt_burn$X<-NULL
colnames(cenpl_cnt_burn)[2]<-"cenpl_burn_count"
cenpl_cnt_threat<-read.csv("data\\JCA\\count_cenpl_threat.csv")
...
#6 all gacc 
#6.1 gacc 
gacc_cnt_burn<-read.csv("data\\JCA\\burn_gacc_cnt.csv")
gacc_cnt_burn$X<-NULL
colnames(gacc_cnt_burn)[2]<-"gacc_burn_count"
gacc_cnt_threat<-read.csv("data\\JCA\\threat_gacc_cnt.csv")
...
write.csv(inc_jur_counts,"incid_withjuris_counts.csv")
