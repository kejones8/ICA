...
write.csv(type12_wf_inc_nimo,"oursample.csv")
...
**\textcolor{red}{1. INVESTIGATE WHY NO COMPLEXES IN LATER YEARS (look in the ics209-plus-wf_incidents_1999to2020.csv)}**
...
**\textcolor{red}{4. INVESTIGATE INCIDENTS THAT SHOW *NA* FOR "FOD_FIRE_NUM" & INCIDENTS THAT HAVE GREATER THAN 10 FOR "FOD_FIRE_NUM". ALSO, MAKE SURE THAT NON-COMPLEX INCIDENTS ONLY HAVE AN "FOD_FIRE_NUM" OF 1.}**
